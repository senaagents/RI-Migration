...
def export_company_data(company_name="Avinash Industries", company_abbr="AI", export_dir=_DEFAULT_EXPORT_DIR):
	...
	Call via: bench --site dev.localhost execute migration.core.prod_sync.export_company_data
	"""
...
def import_company_data(import_dir=_DEFAULT_EXPORT_DIR):
	...
	Call via: bench --site <prod_site> execute migration.core.prod_sync.import_company_data
	"""
	results = {}
