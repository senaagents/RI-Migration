const API_BASE = '/api/method/custom_app_migration.custom_app_migration.custom_app_migration.api'
...
function callBridgeAPI(method, params = {}) {
  return new Promise((resolve, reject) => {
    ...
    window.parent.postMessage({
      type: 'sena:api-call',
      id,
      method: `custom_app_migration.custom_app_migration.custom_app_migration.api.${method}`,
      params,
    }, '*')
    // Timeout after 30s
    setTimeout(() => {
